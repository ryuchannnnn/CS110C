...
// random add here 
template<class ItemType>
BinaryNode<ItemType>* BinaryNodeTree<ItemType>::randomAdd(BinaryNode<ItemType>* subTreePtr, BinaryNode<ItemType>* newNodePtr)
{
 int randomSide = rand();
 if (subTreePtr == nullptr)
 {
...
template <class ItemType>
bool BinaryNodeTree<ItemType>::randomAdd(const ItemType& newData)
{
   BinaryNode<ItemType>* newNodePtr = new BinaryNode<ItemType>(newData);
